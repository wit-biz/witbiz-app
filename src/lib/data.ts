    ...
    stages: [
      ...
      },
      {
        ...
        actions: [
          ...
          { id: 'ef-propuesta-3', title: 'Registrar negociación del cierre', order: 3, subActions: [] },
        ],
        subStages: [],
      },
      {
        ...
        actions: [
          ...
          { id: 'ef-onboarding-2', title: 'Check list de documentos – Persona Moral', order: 2, subActions: [], requiredDocumentForCompletion: true, requiredDocuments: [
              ...
              {id: 'doc-ef-pm-6', description: 'Vista previa de la declaración correspondiente'}, 
              {id: 'doc-ef-pm-7', description: 'Correo electrónico del SAT'}, 
              {id: 'doc-ef-pm-8', description: 'CIEC de la empresa'}
          ] },
          { id: 'ef-onboarding-3', title: 'Check list de documentos – Persona Física', order: 3, subActions: [], requiredDocumentForCompletion: true, requiredDocuments: [
              ...
              {id: 'doc-ef-pf-5', description: 'Vista previa de la declaración correspondiente'}, 
              {id: 'doc-ef-pf-6', description: 'Correo electrónico del SAT'}, 
              {id: 'doc-ef-pf-7', description: 'CIEC de la empresa'}
          ] },
        ],
        subStages: [],
      },
  ...
  },
  {
    ...
    stages: [
      ...
      },
      {
        ...
        order: 2,
        actions: [
          { id: 'f-propuesta-1', title: 'Registrar negociación del cierre', order: 1, subActions: [] },
        ],
        subStages: [],
      },
      {
