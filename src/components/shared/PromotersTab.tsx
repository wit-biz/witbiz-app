...
import { Loader2, Download, HardDriveDownload, Presentation, Image as ImageIcon, CircleDollarSign, Users, TrendingUp, Info, CalendarIcon } from 'lucide-react';
...
export function PromotersTab({ isStandalonePage = false }: PromotersTabProps) {
    ...
    const content = (
        <div className="space-y-6">
            ...
            <Tabs defaultValue="clients">
                <TabsList className={cn("grid w-full mb-6", isStandalonePage ? "grid-cols-4" : "grid-cols-3")}>
                    <TabsTrigger value="clients"><Users className="mr-2 h-4 w-4"/>Clientes Referidos</TabsTrigger>
                    <TabsTrigger value="commissions"><CircleDollarSign className="mr-2 h-4 w-4"/>Comisiones</TabsTrigger>
                    {isStandalonePage && <TabsTrigger value="stats"><TrendingUp className="mr-2 h-4 w-4"/>Estadísticas</TabsTrigger>}
    ...
    // Render inside a single card if it's just a tab in another page
    return (
        <Card>
